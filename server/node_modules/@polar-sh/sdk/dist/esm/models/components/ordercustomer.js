...
/** @internal */
export const OrderCustomerMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const OrderCustomerMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
