...
/** @internal */
export const CustomerStateMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const CustomerStateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
