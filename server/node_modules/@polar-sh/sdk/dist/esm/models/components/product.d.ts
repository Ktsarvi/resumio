...
/** @internal */
export declare const ProductMetadata$inboundSchema: z.ZodMiniType<ProductMetadata, unknown>;
/** @internal */
export type ProductMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const ProductMetadata$outboundSchema: z.ZodMiniType<ProductMetadata$Outbound, ProductMetadata>;
