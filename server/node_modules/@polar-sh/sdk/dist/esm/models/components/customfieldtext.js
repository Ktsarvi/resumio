...
/** @internal */
export const CustomFieldTextMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const CustomFieldTextMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const CustomFieldText$inboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomFieldText$outboundSchema = z.pipe(z.object({
