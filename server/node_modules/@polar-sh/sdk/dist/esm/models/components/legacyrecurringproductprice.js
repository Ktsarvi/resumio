...
export const LegacyRecurringProductPrice$inboundSchema = z.union([
    z.intersection(LegacyRecurringProductPriceCustom$inboundSchema, z.pipe(z.object({ amount_type: z.literal("custom") }), z.transform((v) => ({ amountType: v.amount_type })))),
    z.intersection(LegacyRecurringProductPriceFixed$inboundSchema, z.pipe(z.object({ amount_type: z.literal("fixed") }), z.transform((v) => ({ amountType: v.amount_type })))),
    z.intersection(LegacyRecurringProductPriceFree$inboundSchema, z.pipe(z.object({ amount_type: z.literal("free") }), z.transform((v) => ({ amountType: v.amount_type })))),
]);
/** @internal */
export const LegacyRecurringProductPrice$outboundSchema = z.union([
    z.intersection(LegacyRecurringProductPriceCustom$outboundSchema, z.pipe(z.object({ amountType: z.literal("custom") }), z.transform((v) => ({ amount_type: v.amountType })))),
    z.intersection(LegacyRecurringProductPriceFixed$outboundSchema, z.pipe(z.object({ amountType: z.literal("fixed") }), z.transform((v) => ({ amount_type: v.amountType })))),
    z.intersection(LegacyRecurringProductPriceFree$outboundSchema, z.pipe(z.object({ amountType: z.literal("free") }), z.transform((v) => ({ amount_type: v.amountType })))),
]);
