...
/** @internal */
export const BenefitCustomMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const BenefitCustomMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const BenefitCustom$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
/** @internal */
export const BenefitCustom$outboundSchema = z.pipe(z.object({
    id: z.string(),
