...
/** @internal */
export const CustomerStateSubscriptionMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const CustomerStateSubscriptionMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
