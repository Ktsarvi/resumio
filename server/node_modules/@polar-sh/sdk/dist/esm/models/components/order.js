...
/** @internal */
export const OrderMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const OrderMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
