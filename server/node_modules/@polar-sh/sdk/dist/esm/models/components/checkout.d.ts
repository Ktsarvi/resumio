...
/** @internal */
export declare const CheckoutMetadata$inboundSchema: z.ZodMiniType<CheckoutMetadata, unknown>;
/** @internal */
export type CheckoutMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const CheckoutMetadata$outboundSchema: z.ZodMiniType<CheckoutMetadata$Outbound, CheckoutMetadata>;
