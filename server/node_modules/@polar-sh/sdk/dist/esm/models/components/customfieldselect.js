...
/** @internal */
export const CustomFieldSelectMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const CustomFieldSelectMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const CustomFieldSelect$inboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomFieldSelect$outboundSchema = z.pipe(z.object({
