...
/** @internal */
export const DiscountFixedRepeatDurationBaseMetadata$inboundSchema = z.union([
    z.string(),
    z.int(),
    z.number(),
    z.boolean(),
...
/** @internal */
export const DiscountFixedRepeatDurationBaseMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
