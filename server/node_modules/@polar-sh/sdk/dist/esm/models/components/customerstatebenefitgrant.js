...
/** @internal */
export const BenefitMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const BenefitMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
