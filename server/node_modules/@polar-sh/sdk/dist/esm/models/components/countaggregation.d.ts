...
/** @internal */
export declare const CountAggregation$inboundSchema: z.ZodMiniType<CountAggregation, unknown>;
/** @internal */
export type CountAggregation$Outbound = {
    func: "count";
};
/** @internal */
export declare const CountAggregation$outboundSchema: z.ZodMiniType<CountAggregation$Outbound, CountAggregation>;
