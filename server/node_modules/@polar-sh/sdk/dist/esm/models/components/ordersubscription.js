...
/** @internal */
export const OrderSubscriptionMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const OrderSubscriptionMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
