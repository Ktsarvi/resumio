...
/** @internal */
export const CustomFieldCheckboxMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const CustomFieldCheckboxMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const CustomFieldCheckbox$inboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomFieldCheckbox$outboundSchema = z.pipe(z.object({
