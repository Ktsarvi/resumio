...
/** @internal */
export const ProductMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const ProductMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
