...
/** @internal */
export declare const OrderProductMetadata$inboundSchema: z.ZodMiniType<OrderProductMetadata, unknown>;
/** @internal */
export type OrderProductMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const OrderProductMetadata$outboundSchema: z.ZodMiniType<OrderProductMetadata$Outbound, OrderProductMetadata>;
