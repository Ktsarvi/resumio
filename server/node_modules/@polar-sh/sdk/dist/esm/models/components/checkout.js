...
/** @internal */
export const CheckoutMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const CheckoutMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
