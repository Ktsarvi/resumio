...
/** @internal */
export const BenefitMeterCreditMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
export const BenefitMeterCreditMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const BenefitMeterCredit$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
/** @internal */
export const BenefitMeterCredit$outboundSchema = z.pipe(z.object({
    id: z.string(),
