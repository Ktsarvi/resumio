...
/** @internal */
export declare const BenefitDiscordMetadata$inboundSchema: z.ZodMiniType<BenefitDiscordMetadata, unknown>;
/** @internal */
export type BenefitDiscordMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const BenefitDiscordMetadata$outboundSchema: z.ZodMiniType<BenefitDiscordMetadata$Outbound, BenefitDiscordMetadata>;
...
/** @internal */
export declare const BenefitDiscord$inboundSchema: z.ZodMiniType<BenefitDiscord, unknown>;
/** @internal */
...
/** @internal */
export declare const BenefitDiscord$outboundSchema: z.ZodMiniType<BenefitDiscord$Outbound, BenefitDiscord>;
