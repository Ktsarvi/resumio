...
import { DownloadableFileRead } from "../components/downloadablefileread.js";
import { FileUploadCompleted, FileUploadCompleted$Outbound } from "../components/fileuploadcompleted.js";
import { OrganizationAvatarFileRead } from "../components/organizationavatarfileread.js";
import { ProductMediaFileRead } from "../components/productmediafileread.js";
...
/** @internal */
export declare const FilesUploadedRequest$outboundSchema: z.ZodMiniType<FilesUploadedRequest$Outbound, FilesUploadedRequest>;
export declare function filesUploadedRequestToJSON(filesUploadedRequest: FilesUploadedRequest): string;
/** @internal */
export declare const FilesUploadedResponseFilesUploaded$inboundSchema: z.ZodMiniType<FilesUploadedResponseFilesUploaded, unknown>;
