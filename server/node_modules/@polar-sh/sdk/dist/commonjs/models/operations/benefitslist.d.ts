...
import { ListResourceBenefit } from "../components/listresourcebenefit.js";
...
/** @internal */
export declare const QueryParamOrganizationIDFilter$outboundSchema: z.ZodMiniType<QueryParamOrganizationIDFilter$Outbound, QueryParamOrganizationIDFilter>;
...
/** @internal */
export declare const BenefitTypeFilter$outboundSchema: z.ZodMiniType<BenefitTypeFilter$Outbound, BenefitTypeFilter>;
...
/** @internal */
export declare const BenefitsListRequest$outboundSchema: z.ZodMiniType<BenefitsListRequest$Outbound, BenefitsListRequest>;
export declare function benefitsListRequestToJSON(benefitsListRequest: BenefitsListRequest): string;
/** @internal */
export declare const BenefitsListResponse$inboundSchema: z.ZodMiniType<BenefitsListResponse, unknown>;
