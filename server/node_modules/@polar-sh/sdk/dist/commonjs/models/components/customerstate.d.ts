...
/** @internal */
export declare const CustomerStateMetadata$inboundSchema: z.ZodMiniType<CustomerStateMetadata, unknown>;
/** @internal */
export type CustomerStateMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const CustomerStateMetadata$outboundSchema: z.ZodMiniType<CustomerStateMetadata$Outbound, CustomerStateMetadata>;
