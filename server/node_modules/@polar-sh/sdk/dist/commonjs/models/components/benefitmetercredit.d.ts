...
/** @internal */
export declare const BenefitMeterCreditMetadata$inboundSchema: z.ZodMiniType<BenefitMeterCreditMetadata, unknown>;
/** @internal */
export type BenefitMeterCreditMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const BenefitMeterCreditMetadata$outboundSchema: z.ZodMiniType<BenefitMeterCreditMetadata$Outbound, BenefitMeterCreditMetadata>;
...
/** @internal */
export declare const BenefitMeterCredit$inboundSchema: z.ZodMiniType<BenefitMeterCredit, unknown>;
/** @internal */
...
/** @internal */
export declare const BenefitMeterCredit$outboundSchema: z.ZodMiniType<BenefitMeterCredit$Outbound, BenefitMeterCredit>;
