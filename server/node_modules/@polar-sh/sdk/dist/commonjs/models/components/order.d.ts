...
/** @internal */
export declare const OrderMetadata$inboundSchema: z.ZodMiniType<OrderMetadata, unknown>;
/** @internal */
export type OrderMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const OrderMetadata$outboundSchema: z.ZodMiniType<OrderMetadata$Outbound, OrderMetadata>;
