...
/** @internal */
export declare const BenefitGitHubRepositoryMetadata$inboundSchema: z.ZodMiniType<BenefitGitHubRepositoryMetadata, unknown>;
/** @internal */
export type BenefitGitHubRepositoryMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const BenefitGitHubRepositoryMetadata$outboundSchema: z.ZodMiniType<BenefitGitHubRepositoryMetadata$Outbound, BenefitGitHubRepositoryMetadata>;
...
/** @internal */
export declare const BenefitGitHubRepository$inboundSchema: z.ZodMiniType<BenefitGitHubRepository, unknown>;
/** @internal */
...
/** @internal */
export declare const BenefitGitHubRepository$outboundSchema: z.ZodMiniType<BenefitGitHubRepository$Outbound, BenefitGitHubRepository>;
