...
exports.CustomerStateBenefitGrant$outboundSchema = exports.CustomerStateBenefitGrant$inboundSchema = exports.CustomerStateBenefitGrantProperties$outboundSchema = exports.CustomerStateBenefitGrantProperties$inboundSchema = exports.BenefitMetadata$outboundSchema = exports.BenefitMetadata$inboundSchema = void 0;
...
/** @internal */
exports.BenefitMetadata$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
/** @internal */
exports.BenefitMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
exports.CustomerStateBenefitGrant$inboundSchema = z.pipe(z.object({
    ...
    benefit_metadata: z.record(z.string(), z.union([z.string(), z.int(), z.number(), z.boolean()])),
    properties: z.union([
        benefitgrantdiscordproperties_js_1.BenefitGrantDiscordProperties$inboundSchema,
        benefitgrantgithubrepositoryproperties_js_1.BenefitGrantGitHubRepositoryProperties$inboundSchema,
        benefitgrantdownloadablesproperties_js_1.BenefitGrantDownloadablesProperties$inboundSchema,
...
exports.CustomerStateBenefitGrant$outboundSchema = z.pipe(z.object({
    ...
    benefitMetadata: z.record(z.string(), z.union([z.string(), z.int(), z.number(), z.boolean()])),
    properties: z.union([
        benefitgrantdiscordproperties_js_1.BenefitGrantDiscordProperties$outboundSchema,
        benefitgrantgithubrepositoryproperties_js_1.BenefitGrantGitHubRepositoryProperties$outboundSchema,
        benefitgrantdownloadablesproperties_js_1.BenefitGrantDownloadablesProperties$outboundSchema,
