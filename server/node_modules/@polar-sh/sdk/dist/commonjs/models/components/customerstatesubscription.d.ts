...
/** @internal */
export declare const CustomerStateSubscriptionMetadata$inboundSchema: z.ZodMiniType<CustomerStateSubscriptionMetadata, unknown>;
/** @internal */
export type CustomerStateSubscriptionMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const CustomerStateSubscriptionMetadata$outboundSchema: z.ZodMiniType<CustomerStateSubscriptionMetadata$Outbound, CustomerStateSubscriptionMetadata>;
