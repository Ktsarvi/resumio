...
/** @internal */
export declare const OrderCustomerMetadata$inboundSchema: z.ZodMiniType<OrderCustomerMetadata, unknown>;
/** @internal */
export type OrderCustomerMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const OrderCustomerMetadata$outboundSchema: z.ZodMiniType<OrderCustomerMetadata$Outbound, OrderCustomerMetadata>;
