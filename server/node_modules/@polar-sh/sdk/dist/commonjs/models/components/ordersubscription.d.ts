...
/** @internal */
export declare const OrderSubscriptionMetadata$inboundSchema: z.ZodMiniType<OrderSubscriptionMetadata, unknown>;
/** @internal */
export type OrderSubscriptionMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const OrderSubscriptionMetadata$outboundSchema: z.ZodMiniType<OrderSubscriptionMetadata$Outbound, OrderSubscriptionMetadata>;
