...
export type CheckoutCreatePrices = (ProductPriceMeteredUnitCreate & {
...
export type CheckoutCreate = {
     ...
     */
    prices?: {
        [k: string]: Array<(ProductPriceMeteredUnitCreate & {
            amountType: "metered_unit";
        }) | (ProductPriceFixedCreate & {
            amountType: "fixed";
        }) | (ProductPriceSeatBasedCreate & {
...
/** @internal */
export type CheckoutCreatePrices$Outbound = (ProductPriceMeteredUnitCreate$Outbound & {
...
export type CheckoutCreate$Outbound = {
    ...
    products: Array<string>;
    prices?: {
        [k: string]: Array<(ProductPriceMeteredUnitCreate$Outbound & {
            amount_type: "metered_unit";
        }) | (ProductPriceFixedCreate$Outbound & {
            amount_type: "fixed";
        }) | (ProductPriceSeatBasedCreate$Outbound & {
