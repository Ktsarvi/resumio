...
/** @internal */
export declare const CustomerMetadata1$inboundSchema: z.ZodMiniType<CustomerMetadata1, unknown>;
/** @internal */
export type CustomerMetadata1$Outbound = string | number | number | boolean;
/** @internal */
export declare const CustomerMetadata1$outboundSchema: z.ZodMiniType<CustomerMetadata1$Outbound, CustomerMetadata1>;
