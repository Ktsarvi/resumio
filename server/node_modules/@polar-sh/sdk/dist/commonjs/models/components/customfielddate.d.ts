...
/** @internal */
export declare const CustomFieldDateMetadata$inboundSchema: z.ZodMiniType<CustomFieldDateMetadata, unknown>;
/** @internal */
export type CustomFieldDateMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const CustomFieldDateMetadata$outboundSchema: z.ZodMiniType<CustomFieldDateMetadata$Outbound, CustomFieldDateMetadata>;
...
/** @internal */
export declare const CustomFieldDate$inboundSchema: z.ZodMiniType<CustomFieldDate, unknown>;
/** @internal */
...
/** @internal */
export declare const CustomFieldDate$outboundSchema: z.ZodMiniType<CustomFieldDate$Outbound, CustomFieldDate>;
