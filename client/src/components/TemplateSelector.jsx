...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    ...
    },
    {
      ...
      name: "Minimal",
      preview:
        "Ultra-clean design that puts your skills and experience front and center",
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
            ...
            >
              {selectedTemplate === template.id && (
                <div className="absolute top-2 right-2">
                  <div className="size-5 bg-blue-400 rounded-fill flex items-center justify-center">
